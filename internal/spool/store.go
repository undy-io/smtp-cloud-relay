...
type Store interface {
	...
	NextSubmittedReady(ctx context.Context, now time.Time) (Record, bool, error)
	MarkSubmitted(ctx context.Context, rec Record, result email.SubmissionResult, nextAttemptAt time.Time) (Record, error)
