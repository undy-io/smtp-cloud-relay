...
assert_equals "$(read_output_value "${stable_output}" image_sha_ref)" "${registry}/${image_name}:${stable_sha_tag}" "stable sha ref"
assert_equals "$(read_output_value "${stable_output}" image_promote_ref)" "${registry}/${image_name}:${nightly_sha_tag}" "stable promote ref"
...
assert_contains_line "${stable_build_refs}" "${registry}/${image_name}:${stable_sha_tag}"
