...
nightly_tags="$(read_output_multiline "${nightly_output}" image_tags)"
assert_contains_line "${nightly_tags}" "${registry}/${image_name}:${nightly_version}"
assert_contains_line "${nightly_tags}" "${registry}/${image_name}:nightly"
assert_contains_line "${nightly_tags}" "${registry}/${image_name}:${sha_tag}"
...
stable_tags="$(read_output_multiline "${stable_output}" image_tags)"
...
assert_contains_line "${stable_tags}" "${registry}/${image_name}:${chart_version}"
assert_contains_line "${stable_tags}" "${registry}/${image_name}:${stable_major}.${stable_minor}"
assert_contains_line "${stable_tags}" "${registry}/${image_name}:${stable_major}"
assert_contains_line "${stable_tags}" "${registry}/${image_name}:latest"
assert_contains_line "${stable_tags}" "${registry}/${image_name}:${sha_tag}"
