...
- `DELIVERY_MODE` (`acs` or `noop`, default `acs`)
...
- `ACS_RETRY_ATTEMPTS` (default `3`)
- `ACS_RETRY_BASE_DELAY_MS` (default `1000`)
- `ACS_HTTP_TIMEOUT_MS` (default `30000`)
- `ACS_HTTP_MAX_IDLE_CONNS` (default `200`)
- `ACS_HTTP_MAX_IDLE_CONNS_PER_HOST` (default `50`)
- `ACS_HTTP_IDLE_CONN_TIMEOUT_MS` (default `90000`)
